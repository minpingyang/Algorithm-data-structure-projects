...
public class Board {
	...
	private int cols = 10;
	Piece[][]piecesBoard;// the 10*10 2D array to store all the pieces of the board
	...
	private boolean hasCreate; // the boolean indicating if this turn, the player already created a piece
	...
	/**
	 * This method is used to print out the board, which depends on what the type of the piece in the 2D 
	 *So, firstly, fill all pieces into 2D array
	 *Then, print out the piece and their equipments(weapon) to the 30*30 board
	 * **/
