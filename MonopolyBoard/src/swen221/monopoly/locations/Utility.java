...
/**
 * Represents a utility on the board, which is a property that can be bought or
 * sold. As for stations, the rent calculation for a utility is dependent on
 * whether the given landlord owns one or both of the utilities.
 * 
