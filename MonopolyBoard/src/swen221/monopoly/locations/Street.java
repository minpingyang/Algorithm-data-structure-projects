...
/**
 * Represents a street on the board, such as "Vine Street" or "Park Lane".
 * Streets can be bought and sold, and can have houses and hotels built on them.
 * Their rent is a function of the base rate, and the number of houses / hotels
 * built on them.
 * 
