...
/**
 * This is a wrapper class for a list of row. 
 * Furthermore, it wraps in a parent pointer to the table it belongs to.
 * 
 * @author Minping
 *
 */
public class MyRowList implements List<List<Value>> {
    ...
    public boolean add(List<Value> element) {
        ...
        MyDatabase.addRow(this, element);
        // if there is a reference value, need to update two maps in MyDatabase.
        MyDatabase.setReference(table, addedRow);
    ...
    public void add(int index, List<Value> element) {
        MyRow addedRow = new MyRow(table, element);
        MyDatabase.addRow(this, element);
        // if there is a reference value, need to set new hash maps in MyDatabase.
        MyDatabase.setReference(table, addedRow);
    ...
    public List<Value> remove(int index) {
        ...
        // cascading delete:
        Map<List<Value>, Set<MyRow>> rowToRefRow = table.getDatabase().getRowToMyRow();
