...
public class Piece {
	...
	/**
     * This method is used to get the selected piece in four different degree
     * @param degree the rotation
     * @param ot  other pieces
     *@return  Piece  the piece after being rotated
     * **/
	...
	/**
	 * This method is a helper method to helper draw weapon
     *@param  g
     * @param x
     *@param y
     *@@param  col   is vertical direction weapon or horizontal
     *@param  offset  the weapon offset
     * */
    ...
    /**
     * This method is a helper method to helper draw weapon for rotation piece
     *@param  g
     * @param x
     *@param y
     *@@param  col   is vertical direction weapon or horizontal
     ...
     * This method is a helper method to helper draw weapon
     *@param  g
     * @param x  the coordinator of the weapon
     *@param y
     * */
    ...
    /**
     *This method is used to draw a dark blue circle in the
     *@param  g
     * */
	...
	/**
     * This method is used to highlight select piece
     * **/
    ...
    /**
     * this methodd is used to draw rotation piece
     * **/
